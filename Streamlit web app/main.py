...
def main():
    ...
    demo_vid_paths={
        "Demo 1":'D:\Football-Analytics-with-Deep-Learning-and-Computer-Vision-master\Streamlit web app\demo_vid_1.mp4',
        "Demo 2":'D:\Football-Analytics-with-Deep-Learning-and-Computer-Vision-master\Streamlit web app\demo_vid_2.mp4'
    }
    ...
    model_players = YOLO("D:/Football-Analytics-with-Deep-Learning-and-Computer-Vision-master/models/Yolo8L Players/weights/best.pt")
    # Load the YOLOv8 field keypoints detection model
    model_keypoints = YOLO("D:/Football-Analytics-with-Deep-Learning-and-Computer-Vision-master/models/Yolo8M Field Keypoints/weights/best.pt")
